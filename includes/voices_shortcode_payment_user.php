<?php
	...
	add_shortcode("voa_payment_user","voa_payment_short_fn_user");
	function voa_payment_short_fn_user(){
		ob_start();
			include_once("templates/voices_template_shortcode_payment_user.php");
	    return ob_get_clean();
	}
	add_action("wp_ajax_voa_filter_payment_user","voa_filter_payment_callback_user");

	add_action("wp_ajax_nopriv_voa_filter_payment_user","voa_filter_payment_callback_user");

	function voa_filter_payment_callback_user(){
